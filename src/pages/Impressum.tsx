  ...
  return (
    <div className="min-h-screen bg-background">
      <main className="mx-auto max-w-2xl px-6 py-20 md:py-32">
        ...
        <h1 className="mt-8 text-3xl font-semibold tracking-tight text-foreground">Impressum</h1>

        <section className="mt-10 space-y-8 text-muted-foreground">
          <div>
            <h2 className="text-sm font-medium uppercase tracking-widest text-foreground">Angaben gemäß § 5 TMG</h2>
            <p className="mt-4">
              Tobias Bechtold
              <br />
          ...
          <div>
            <h2 className="text-sm font-medium uppercase tracking-widest text-foreground">Kontakt</h2>
            <p className="mt-4">
              E-Mail:{" "}
              <a
                href="mailto:contact@tobibechtold.dev"
                className="text-primary transition-colors hover:text-primary/80"
              >
                contact@tobibechtold.dev
              </a>
            </p>
          </div>

          <div>
            <h2 className="text-sm font-medium uppercase tracking-widest text-foreground">Haftungsausschluss</h2>
